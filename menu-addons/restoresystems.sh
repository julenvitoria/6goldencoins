...
#cps
if grep -q "<name>cps</name>" /etc/emulationstation/es_systems.cfg ; then
...
#cps1   
if grep -q "<name>cps1</name>" /etc/emulationstation/es_systems.cfg ; then
...
#cps2
if grep -q "<name>cps2</name>" /etc/emulationstation/es_systems.cfg ; then
...
#cps3
if grep -q "<name>cps3</name>" /etc/emulationstation/es_systems.cfg ; then
...
#light gun
if grep -q "<name>Light-Gun-collection</name>" /etc/emulationstation/es_systems.cfg ; then
...
#pixel
if grep -q "<name>pixel</name>" /etc/emulationstation/es_systems.cfg ; then
